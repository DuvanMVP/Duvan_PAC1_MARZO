...
while True:
   ...
   totalmente_recaudado += precio_con_descuento

   print(f"El precio final con descuento es: {precio_con_descuento:.2f}")

print("\nResumen de Ventas:")
for categoria, cantidad in productos_por_categoria.items():
   print(f"Cantidad de varios productos de {categoria}: {cantidad}")

print(f"\nTotal recaudado: {totalmente_recaudado:.2f}")